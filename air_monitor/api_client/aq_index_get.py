        ...
        aq_index = {
            ...
            'param': {
                'SO2': {
                    ...
                    'date_calcs': safe_get(data, 'Data wykonania obliczeń indeksu dla wskaźnika SO2'),
                ...
                'NO2': {
                    ...
                    'date_calcs': safe_get(data, 'Data wykonania obliczeń indeksu dla wskaźnika NO2'),
                ...
                'PM10': {
                    ...
                    'date_calcs': safe_get(data, 'Data wykonania obliczeń indeksu dla wskaźnika PM10'),
                ...
                'PM2.5': {
                    ...
                    'date_calcs': safe_get(data, 'Data wykonania obliczeń indeksu dla wskaźnika PM2.5'),
                ...
                'O3': {
                    ...
                    'date_calcs': safe_get(data, 'Data wykonania obliczeń indeksu dla wskaźnika O3'),
